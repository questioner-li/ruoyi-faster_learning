<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="挂号量" prop="departmentNum">
        <el-input
      ...
      <el-form-item label="负责人" prop="departmentPerson">
        <el-input
      ...
      <el-form-item label="手机号" prop="departmentPhone">
        <el-input
          v-model="queryParams.departmentPhone"
          placeholder="请输入手机号"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="departmentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="挂号量" align="center" prop="departmentNum" />
      <el-table-column label="负责人" align="center" prop="departmentPerson" />
      <el-table-column label="手机号" align="center" prop="departmentPhone" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="挂号量" prop="departmentNum">
          <el-input v-model="form.departmentNum" placeholder="请输入挂号量" />
        </el-form-item>
        <el-form-item label="负责人" prop="departmentPerson">
          <el-input v-model="form.departmentPerson" placeholder="请输入负责人" />
        </el-form-item>
        <el-form-item label="手机号" prop="departmentPhone">
          <el-input v-model="form.departmentPhone" placeholder="请输入手机号" />
        </el-form-item>
